  ...
  return (
    <section className="bg-black h-screen lg:grid">
      <div className="flex items-baseline justify-center pt-10">
        <h2 className="text-white border-2 px-6 py-2 border-indigo-500 rounded-4xl text-sm">
          Introducing Visual Thinking Pad ✨
        </h2>
      </div>
      <div className="mx-auto w-screen max-w-screen-xl px-4 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
        <div className=" mx-auto max-w-prose text-center">
          <h1 className="text-7xl font-medium text-white sm:text-5xl tracking-tight">
